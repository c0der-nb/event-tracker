...
export default function() {
    ...
    const handleFormSubmit = async (e) => {
        ...
        if (validateFormData(formData)) {
            ...
            const payload = {...formData, id: uuidv4(), image: `https://randomuser.me/api/portraits/men/${imageNumber}.jpg`};
            try {
    ...
    return (
        <div className='h-[80vh] w-full flex flex-row justify-center items-center'>
            <form className="h-[350px] w-[550px] flex flex-row flex-wrap shadow-md p-8 gap-x-4" onSubmit={handleFormSubmit}>
                <input 
                    type="text" 
                ...
                <input
                    ...
                    required
                />
                <button className='h-[40px] w-[130px] text-center bg-red-500 text-white border-none text-sm rounded' type="submit">Create Event</button>
            </form>
        </div>
    )
}